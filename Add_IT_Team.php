                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Add IT Team</h5>
                                            <p class="m-b-0"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="Add_IT_Team.php">Add IT Team</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <!-- Basic Form Inputs card start -->
                                                           ...
                                                           <form action="insert_addITteam.php" method="POST">
                                                            ...
                                                            <div class="form-group row">
                                                             ...
                                                             <div class="form-group row">
                                                                ...
                                                                <label>Confirm Password</label>
                                                                    <input type="text" class="form-control" name="conpwd" id="conpwd">
                                                                </div>
                                                             </div>
